...
<div id="wrapper">
    ...
    <div id="rightcol">
        ...
        <div id="shadowbox">
            <main>
                <div>
                    <h3>CUSTOMER SERVICE REP. - Rider Password Reset</h3>
                    ...
                    <form method="POST" action="new-oracle-test.php">
                        ...
                        <input type="submit" value="Get Temporary Password" name="getNewPassword">

                        <p>
                            Display the generated password which should now replace the rider's old password in the
                            database.
                        </p>
